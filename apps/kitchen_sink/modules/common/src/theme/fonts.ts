...
export const Fonts = {
  ...
  h4: systemBoldFont(FontSizes.lg),            // Bold 18pt
  h5: systemBoldFont(FontSizes.base),          // Bold 16pt
  h6: systemBoldFont(FontSizes.sm),            // Bold 14pt
  ...
  // Button text
  button: systemBoldFont(FontSizes.base),      // Bold 16pt
  buttonSmall: systemBoldFont(FontSizes.sm),   // Bold 14pt
  ...
  // Labels
  label: systemBoldFont(FontSizes.base),       // Bold 16pt
  labelSmall: systemBoldFont(FontSizes.sm),    // Bold 14pt
} as const;
